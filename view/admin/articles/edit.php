        ...
        <div class="d-flex flex-row justify-content-around"> 
            ...
            <input type="hidden" name="id" value="<?=$this->data['article']['id']?>">
                ...
                <div class="form-group">
                    ...
                    <input type="file" class="form-control-file <?=isset($this->data['validation_info']) ? (isset($this->data['validation_info']['errors']['photos']) ? "is-invalid" : "is-valid") : "" ?>" id="photos" name="photos[]" multiple>
