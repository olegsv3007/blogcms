...
<h2>Управление статичными страницами</h2>
    <a href="/admin/articles/add.php" class="btn btn-primary my-3 float-left">Добавить страницу</a>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <tr>
                ...
                <td>Mark</td>
                <td>Otto</td>
                <td><a href="/admin/statics/edit.php" class="btn btn-sm btn-dark">Редактировать</a></td>      
