...
<h2>Управление статьями</h2>
    <a href="/admin/articles/add.php" class="btn btn-primary my-3 float-left">Добавить статью</a>
    ...
    <table class="table table-striped">
        ...
        <tbody>
            <tr>
                ...
                <td>Mark</td>
                <td>Otto</td>
                <td><a href="/admin/articles/edit.php" class="btn btn-sm btn-dark">Редактировать</a></td>      
